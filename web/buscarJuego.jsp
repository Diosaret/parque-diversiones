                ...
                <div class="card ">
                    ...
                    <div class="con">
                     ...
                     <table>
                            ...
                            List<Juego> lista = control.buscarTodoJuego();
                           ...
                           for(Juego jue : lista){%>
                            ...
                            <td><%=jue.getEdad_minima()%></td>
                             <td><%=jue.getValor_puntos()%></td> 
                      ...
                      <h2 class="colorFondo">EMPLEADOS ENCARGADOS POR JUEGO</h2>
                     <table>
                            <tr>
                      ...
                      <% Controladora control1 = new Controladora();
                            ...
                            List<Juego> lista1 = control1.buscarTodoJuego();
                            
                           for(Juego jue : lista1){
                            
                           List<Empleado> emple = jue.getUn_empleado();
                             
                             for(Empleado em : emple){
                     ...
                     <br>
                      <h2 class="colorFondo">HORARIO POR JUEGO</h2>
                     <table>
                            <tr>
                      ...
                      <% Controladora control2= new Controladora();
                           ...
                           List<Horario> hora = jue.getUn_horario();
                             
                             for(Horario hor : hora){
                                 
                            %>
                             <tr>
                            <td><%=jue.getNombre()%></td>
                            <td><%=hor.getHora_turno()%></td>
