          ...
          <section >
            ...
            <div >
                ...
                <div class="card ">
                      ...
                      <form action="ModificarEmpleadoServlets" method="POST">
                            
                            <ul>
                                <li>
                                    <h2> Empleado a Modificar</h2>
                                    
                                    <label> Nombre: </label><input type="text" name="nombre"  value="<%= mise1.getAttribute("nombre")%>">
                                </li>
                               
                                <li>
                                    
                                     <label> Apellido: </label><input type="text" name="apellido"value="<%= mise1.getAttribute("apellido")%>">
                                </li>
                                
                                 <li>
                                    
                                     <label> Cargo: </label><input type="text" name="cargo" value="<%= mise1.getAttribute("cargo")%>">
                                </li>
                                
                                 <li>
                                    
                                     <label> Dni: </label><input type="text" name="dni"value="<%= mise1.getAttribute("dni")%>">
                                </li>
