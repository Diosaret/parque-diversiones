       ...
       <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
            <a href="crearCiente.jsp" class="nav-link">
            ...
            <div >
             ...
             <h1 class="m-0 text-dark center ">Bienvenido al Sistema venta de Entradas</h1>
                <div class="card ">
                     ...
                     <div class="con">
                         <h2 class="colorFondo"> CREAR CLIENTE</h2>
                        <form action="CrearClienteServlets" method="POST" >
                           ...
                           <li>
                            <label>Edad: </label><input type="text" name="edad" placeholder="Edad"> 
                                </li>
                         ...
                         <br><br>
                           ...
                           <form action="BorrarClienteServlets" method="POST">
                            ...
                            <h2 class="colorFondo"> BUSCAR TODOS LOS CLIENTES</h2>
                           <form action="buscarCliente.jsp" method="POST">
                            
                            
                               
                                
                                <li> <input type="submit" value="BUSCAR CLIENTE" name="agregar" class="btn"></li>
