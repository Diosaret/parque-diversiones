            ...
            <div >
             ...
             <h1 class="m-0 text-dark center ">Bienvenido al Sistema venta de Entradas</h1>
                <div class="card ">
                     ...
                     <div class="con">
                         <h2 class="colorFondo"> VENTA DE ENTRADA</h2>
                        <form action="VentaServlets" method="POST" >
                            ...
                            <label>Fecha: </label><input type="Date" name="fecha"> 
                                       ...
                                       <li>
                                           ...
                                           <label>Juego: </label> <select name="juego">
                   
                      <% Controladora control2= new Controladora();
                            
                            List<Juego> lista2 = control2.buscarTodoJuego();
                            
                           for(Juego jue : lista2){
                            
                          
                                 
                            %>
                             
                            <option><%=jue.getNombre()%></option>
                                       <% }%>    </select>
                              ...
                              <li>
                                           ...
                                           <label>Horario: </label> <select name="horario">
                   
                      <% Controladora control3= new Controladora();
                            
                            List<Horario> lista3 = control3.buscarHorario();
                            
                           for(Horario hora: lista3){
                            
                          
                                 
                            %>
                             
                            <option><%=hora.getHora_turno()%></option>
                                       <% }%>    </select>
                                        ...
                                        <li> <input  value="AGREGAR" name="agregar" class="btn"></form></li></ul>
                         <br><br>
                           ...
                           <br><br>
                            ...
                            <h2 class="colorFondo"> BUSCAR ENTRADAS</h2>
                           <form action="buscarCliente.jsp" method="POST">
                            
                            
                               
                                
                                <li> <input  value="BUSCAR CLIENTE" name="agregar" class="btn"></li>
