          ...
          <section >
            ...
            <div >
                ...
                <div class="card ">
                      ...
                      <form action="ModificarUsuarioServlets" method="POST">
                            
                            <ul>
                                <li>
                                    <h2> Usuario a Modificar</h2>
                                    
                                    <label> Usuario: </label><input type="text" name="usuario"  value="<%= mise.getAttribute("usua")%>">
                                </li>
                               
                                <li>
                                    
                                     <label> Contraseña: </label><input type="text" name="contrasenia"value="<%= mise.getAttribute("contra")%>">
                                </li>
                                
                                <li>
                                    
                                     
                                        <% if(mise.getAttribute("ti").equals(1)) {%>
                                        <label>Tipo: </label><select name="ti" >
