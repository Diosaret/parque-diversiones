            ...
            <div >
             ...
             <h1 class="m-0 text-dark center ">Bienvenido al Sistema del Parque de Diversiones</h1>
                <div class="card ">
                    ...
                    <div class="con">
                         <h2 class="colorFondo"> CREAR JUEGO</h2>
                        <form action="CrearJuegoServlets" method="POST" >
                            
                            <ul>
                                <li>
                            <label>Nombre: </label><input type="text" name="nombre" placeholder="Nombre">
                                </li><li>
                            <label>Capacidad: </label><input type="text" name="capacidad" placeholder="Capacidad"> 
                                </li>
                                <li>
                            <label>Edad Mínima: </label><input type="text" name="edad" placeholder="Edad"> 
                                </li>
                                <li>
                            <label>Valor Puntos: </label><input type="text" name="puntos" placeholder="Puntos"> 
                                </li>
                         ...
                         <br><br>
                            ...
                            <h2 class="colorFondo"> BUSCAR TODOS LOS JUEGOS</h2>
                           <form action="buscarJuego.jsp" method="POST">
                            
                            
                               
                                
                                <li> <input type="submit" value="BUSCAR JUEGO" name="agregar" class="btn"></li>
