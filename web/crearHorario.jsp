             ...
             <h1 class="m-0 text-dark center ">Bienvenido al Sistema del Parque de Diversiones</h1>
                <div class="card ">
                    ...
                    <div class="con">
                            ...
                            <h2 class="colorFondo"> BUSCAR TODOS LOS HORARIOS</h2>
                           <form action="buscarHorario.jsp" method="POST">
                            
                            
                               
                                
                                <li> <input type="submit" value="BUSCAR HORARIO" name="agregar" class="btn"></li>
