            ...
            <div >
             ...
             <h1 class="m-0 text-dark center ">Bienvenido al Sistema del Parque de Diversiones</h1>
                <div class="card ">
                    ...
                    <div class="con">
                         <h2 class="colorFondo"> CREAR USUARIO</h2>
                        <form action="CrearUsuarioServlets" method="POST" >
                            
                            <ul>
                                <li>
                            <label>Usuario: </label><input type="text" name="usuario" placeholder="Usuario">
                                </li><li>
                            <label>Contraseña: </label><input type="text" name="contrasenia" placeholder="Contraseña"> 
                                </li><li>
                         ...
                         <br><br>
                           ...
                           <h2 class="colorFondo"> MODIFICAR USUARIO</h2>
                           <form action="BuscarUsuarioServlets" method="POST">
                            
                            <ul>
                                <li>
                                    <h3>Ingrese Usuario que Desea Modificar</h3>
                           ...
                           <br><br>
                            ...
                            <h2 class="colorFondo"> ELIMINAR USUARIO</h2>
                           <form action="BorrarUsuarioServlets" method="POST">
                            
                            <ul>
                                <li>
                                    <h3>Ingrese Usuario que Desea Eliminar</h3>
                            ...
                            <h2 class="colorFondo"> BUSCAR TODOS LOS USUARIOS</h2>
                           <form action="buscarUsuario.jsp" method="POST">
                            
                            
                               
                                
                                <li> <input type="submit" value="BUSCAR USUARIOS" name="agregar" class="btn"></li>
